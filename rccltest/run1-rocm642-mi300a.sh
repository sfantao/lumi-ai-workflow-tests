...
rsync -avhc --progress $SIF run2-rocm642-mi300a.sh  lockhart-login1:/home/sfantao/lumi-ai-workflow-tests/$TESTNAME/
rsync -avhc --progress run2-rocm642-mi300a.sh  lockhart-login1:/home/sfantao/lumi-ai-workflow-tests/$TESTNAME/
ssh lockhart-login1 "bash -eux -c 'cd /home/sfantao/lumi-ai-workflow-tests/$TESTNAME ; TAG=$TAG SIF=$SIF ./run2-rocm642-mi300a.sh '"
